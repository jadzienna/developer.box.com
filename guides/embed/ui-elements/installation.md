...
| Element                                              | バージョン    | ファイル                                                                                                                                                                         |
| ---------------------------------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [コンテンツエクスプローラ](g://embed/ui-elements/explorer)       | `13.0.0` | CSS [`https://cdn01.boxcdn.net/platform/elements/13.0.0/en-US/explorer.css`](https://cdn01.boxcdn.net/platform/elements/13.0.0/en-US/explorer.css)                           |
